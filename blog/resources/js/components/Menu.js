    ...
    render() {
        return (
            <Fragment>
                ...
                <Navbar expand="lg" className="fixed-top shadow-sm bg-white mb-5 py-3" variant="light" bg="light">
                ...
                <div className={this.state.sideNavClass}>
                    ...
                    <NavLink><Link className="NavItem" to="/clientreview"> <FontAwesomeIcon icon={faComment} /><span className={this.state.NavText}> ClientReview</span></Link></NavLink>
